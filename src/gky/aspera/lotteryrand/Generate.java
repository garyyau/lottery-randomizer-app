...
public class Generate extends Activity implements View.OnClickListener {
	...
	Button[] ba = { num1, num2, num3, num4, num5, num6 };
	Button generate;
	
	int[] results = new int[6];
	boolean[] locked = {false, false, false, false, false, false};
	boolean first = true;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.randomgen);
		initialize();
	}

	private void initialize() {
		// TODO Auto-generated method stub
		ba[0] = (Button) findViewById(R.id.bNum1);
		ba[1] = (Button) findViewById(R.id.bNum2);
		ba[2] = (Button) findViewById(R.id.bNum3);
		ba[3] = (Button) findViewById(R.id.bNum4);
		ba[4] = (Button) findViewById(R.id.bNum5);
		ba[5] = (Button) findViewById(R.id.bNum6);
